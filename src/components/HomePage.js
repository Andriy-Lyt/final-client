  ...
  <div>
    <nav className="Navbar">
      ...
      <ul className="Navlist">
        <a  className="Navlistitem new" target="_blank" rel="noopener noreferrer" href="https://design.avaya.com/whats-new/">What's New</a>
        <a href="/#" className="Navlistitem guide">Guidelines</a>
        <a href="/#" className="Navlistitem components">Components</a>
        <a className="Navlistitem faqs" target="_blank" rel="noopener noreferrer" href="https://design.avaya.com/faq/">FAQs</a>
      </ul>
    </nav>
